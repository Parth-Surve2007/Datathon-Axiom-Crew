...
export class CatalystEmployeeRepository implements IEmployeeRepository {
  ...
  async findByBadgeId(badgeId: string): Promise<any | null> { throw new Error('Not implemented'); }
  async findByEmail(email: string): Promise<any | null> { throw new Error('Not implemented'); }
  async findByStation(stationId: string, params: ListParams): Promise<FindManyResult<any>> { throw new Error('Not implemented'); }
  async findByUnit(unitId: string, params: ListParams): Promise<FindManyResult<any>> { throw new Error('Not implemented'); }
}
