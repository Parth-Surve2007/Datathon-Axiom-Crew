...
export type IncidentType = "Theft" | "Assault" | "Robbery" | "Fraud" | "Murder" | "Other";
export type IncidentStatus = "Open" | "Under Investigation" | "Chargesheet Filed" | "Closed";
...
// Keeps the operational map usable when the local Catalyst service is offline.
export const fallbackDistrictCrimeData: DistrictCrimeData[] = [
...
export const fallbackCrimeIncidents: CrimeIncident[] = [
